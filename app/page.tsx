...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white selection:bg-red-500 selection:text-white relative overflow-x-hidden overflow-y-auto md:overflow-hidden">
      ...
      <div className={`relative z-10 w-full min-h-screen md:h-screen flex items-center justify-center p-4 pt-28 pb-32 md:p-0 overscroll-y-none transition-opacity duration-1000 ${interactionsEnabled ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0 md:opacity-100'}`}>
